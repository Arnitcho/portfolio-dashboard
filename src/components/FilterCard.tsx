...
const statusBg     = { pass: 'rgba(16,185,129,0.07)', warn: 'rgba(245,158,11,0.07)', fail: 'rgba(239,68,68,0.07)' }
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
        <span style={{ fontFamily: 'DM Mono, monospace', fontSize: '9px', color: '#4a5568', letterSpacing: '0.1em' }}>
          {filter.id}
        </span>
        <span style={{
          fontFamily: 'DM Mono, monospace', fontSize: '9px', fontWeight: 600, color,
          letterSpacing: '0.1em', background: `${color}15`, padding: '2px 8px',
          borderRadius: '999px', border: `1px solid ${color}25`,
        }}>
          {statusLabels[filter.status]}
        </span>
      </div>

      <div style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '12px', fontWeight: 500, color: '#e8eaf0', marginBottom: '3px', lineHeight: 1.4 }}>
        {filter.name}
      </div>
      <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '10px', color: '#4a5568', marginBottom: '10px' }}>
